...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <div>espacio<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Create a group" />
    </div>
    <div>My groups
...
<asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" AutoGenerateColumns="False" Width="100%" Height="100%" ShowHeader="False" OnSelectedIndexChanged="GridViewTimeline_SelectedIndexChanged" >
                    <Columns>
