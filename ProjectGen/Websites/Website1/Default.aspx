...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectGenNHibernateConnectionString %>" SelectCommand="SELECT Post.description, Usuario.nickname, Usuario.avatar FROM Post INNER JOIN hobby_post ON Post.id = hobby_post.FK_id_idPost INNER JOIN Hobby ON hobby_post.FK_name_idHobby = Hobby.name INNER JOIN Usuario ON Post.FK_nickname_idUser = Usuario.nickname WHERE (Hobby.name = '')"></asp:SqlDataSource>
    </div>
</asp:Content>
