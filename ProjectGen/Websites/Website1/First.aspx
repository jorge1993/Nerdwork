<<<<<<< HEAD:ProjectGen/Websites/Website1/First.aspx
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <div id="index"; style="height: 596px">

       <div id="description"; 
            style="float: left; width: 368px; margin-left: 150px; margin-top: 150px">            
            <h2>Connect with other interesting people.</h2>
            <h2>Watch post of all people with interesting things.</h2>
            <h2>And meet people with the same hobbies</h2>
            
       </div>
        <div id="login"; style="float: right; width: 500px; margin-right: 250px; margin-top: 120px;">
...
>>>>>>> origin/master:ProjectGen/Websites/Website1/Default.aspx
