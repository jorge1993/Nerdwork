...
{
public System.Collections.Generic.IList<ProjectGenNHibernate.EN.Project.EventosEN> SearchByHobbie (string arg0)
{
        /*PROTECTED REGION ID(ProjectGenNHibernate.CEN.Project_Eventos_searchByHobbie) ENABLED START*/
